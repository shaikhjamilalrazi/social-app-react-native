...
<p align="center">
  ...
  Build mobile apps with React. Jamil Arif Rakhu created this app
</p>
...
React Native apps may target iOS 11.0 and Android 5.0 (API 21) or newer. You may use Windows, macOS, or Linux as your development operating system, though building and running iOS apps is limited to macOS. Tools like [Expo](https://expo.io) can be used to work around this.and this is mobile and expo app
...
[repo-website]: https://expo.io/@jamil_expo/social-app-react-native?fbclid=IwAR0de2xzOWav0Hq6rsxIMuVMjLsncNwQH8M-CUg0GXaT77S43JQXZrkxpaQ
